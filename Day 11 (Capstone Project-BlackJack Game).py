...
#Hint 6: Create a function called calculate_score() that takes
#a List of cards as input and returns the score. 
...
#Hint 7: Inside calculate_score() check for a blackjack (a hand
#with only 2 cards: ace + 10) and return 0 instead of the actual score.
#0 will represent a blackjack in our game.
    if sum(cards) == 21 and len(cards) == 2:
        return 0

#Hint 8: Inside calculate_score() check for an 11 (ace).
#If the score is already over 21, remove the 11 and
#replace it with a 1. You might need to look up append()
#and remove().
...
#user_score and computer_score. If the computer and user both
#have the same score, then it's a draw. If the computer has a
#blackjack (0), then the user loses. If the user has a blackjack (0),
...
#computer_cards = []
    ...
    while not is_game_over:
        ...
        print(f"     Computer's first card : {computer_cards[0]}, current_score: {computer_score}")
    ...
    #If they answer yes, clear the console and
